...
class SepetSayfa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void toplamFiyatcik() async {
      toplamFiyat.value += urunToplamFiyat;
    }
                ...
                children: [
                  Expanded(
                    child: ListView.builder(
                      itemCount: sepetCont.sepetListesi.length,
                      itemBuilder: (context, i) {
                        var sepet = sepetCont.sepetListesi[i];
